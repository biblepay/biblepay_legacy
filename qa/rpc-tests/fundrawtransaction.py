...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid biblepay address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid biblepay address" in e.error['message'])
