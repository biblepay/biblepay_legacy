...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 biblepay from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 biblepay in block rewards plus fees, but
        ...
        # Send 100 biblepay with subtract fee from amount
        ...
        # Sendmany 100 biblepay with subtract fee from amount
