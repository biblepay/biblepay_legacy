...
Only requiring some minor changes is biblepay.cpp.
...
Changes to biblepay.cpp
----------------------
biblepay.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
