...
For instance:
    ...
    $ biblepayd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/biblepayd.tx.raw
...
From the perspective of biblepayd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into biblepayd directly. Furthermore, no information is
