...
in the BiblePay Core repository under 'Fetch and create inputs' to install sources which require
...
```bash
    ...
    From https://github.com/biblepay/biblepay
...
BTCPATH=/some/root/path/biblepay
SIGPATH=/some/root/path/biblepay-detached-sigs
...
[biblepay/gitian.sigs](https://github.com/biblepay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
