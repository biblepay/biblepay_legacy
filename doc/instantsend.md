...
* WebSocket: [https://github.com/biblepaypay/insight-api-biblepay#web-socket-api](https://github.com/biblepaypay/insight-api-biblepay#web-socket-api) 
* API: [https://github.com/biblepaypay/insight-api-biblepay#instantsend-transactions](https://github.com/biblepaypay/insight-api-biblepay#instantsend-transactions) 
...
By default, the biblepay Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the biblepay Core daemon:
