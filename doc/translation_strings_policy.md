...
This document provides guidelines for internationalization of the BiblePay Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `biblepay_en.ts` remains unchanged.
