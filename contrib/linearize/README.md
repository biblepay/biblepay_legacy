...
https://github.com/biblepay/biblepay_hash
...
JSON-RPC server. Running `biblepayd` or `biblepay-qt -server` will be sufficient.
...
* `input`: biblepayd blocks/ directory containing blkNNNNN.dat
