...
## biblepay_dbg.sh
This shell script attaches GDB to the running biblepayd process (should be built with debug info), executes debug.gdb script and detaches.
By default it uses testnet settings, see script comments to attach it to mainnet biblepayd.
