...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BiblepayNetwork") type = BiblepayNetwork;
    if(strType == "BiblepayNetworkVariable") type = BiblepayNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BiblepayNetwork) s = "BiblepayNetwork";
    if(type == BiblepayNetworkVariable) s = "BiblepayNetworkVariable";
