...
GLOBAL sph_biblepay512_context  z_biblepay;
...
#define ZBIBLEPAY (memcpy(&ctx_biblepay, &z_biblepay, sizeof(z_biblepay)))
...
template<typename T1>
inline uint256 HashBrokenDog(const T1 pbegin, const T1 pend)
{
...
{
    // BiblePay's Sanctified Seven Step Hashing System - December 16th, 2017 - Modified by Rob Andrew
