...
static const int MASTERNODE_CHECK_SECONDS               = 8 * 5;
static const int MASTERNODE_MIN_MNB_SECONDS             = 8 * 5 * 60;
static const int MASTERNODE_MIN_MNP_SECONDS             = 8 * 10 * 60;
static const int MASTERNODE_EXPIRATION_SECONDS          = 8 * 65 * 60;
static const int MASTERNODE_WATCHDOG_MAX_SECONDS        = 8 * 120 * 60;
...
//
// The Masternode Class. For managing the Darksend process. It contains the input of the 500,000BBP, signature to prove
