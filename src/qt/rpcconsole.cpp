...
// TO DO: add a scrollback limit, as there is currently none
// TO DO: make it possible to filter out categories (esp debug messages when implemented)
// TO DO: receive errors and debug messages through ClientModel
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Biblepay Core RPC console v1.1.") + "<br>" +
