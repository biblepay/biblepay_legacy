...
public Q_SLOTS:
    ...
    */
    ...
    void incomingTransaction(const QString& date, int unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& txid);
#endif // ENABLE_WALLET
...
private Q_SLOTS:
	...
	/** Show built-in prayers or commandments **/
	void sinnerClicked();
