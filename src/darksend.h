...
static const int MIN_PRIVATESEND_PEER_PROTO_VERSION = 70714;
...
{
public:
    /// Is the input associated with this public key? (and there is 500,000 biblepay - checking if valid masternode)
