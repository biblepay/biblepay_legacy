...
BOOST_AUTO_TEST_CASE(CreateNewBlock_validity)
{
    ...
    BOOST_CHECK(pblocktemplate = CreateNewBlock(chainparams, scriptPubKey, "", "", 0, 0, 0, "", sErr));
    ...
    BOOST_CHECK_THROW(CreateNewBlock(chainparams, scriptPubKey, "", "", 0, 0, 0, "", sErr), std::runtime_error);
    mempool.clear();
