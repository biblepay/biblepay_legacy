...
{
    // to do - 12.1 - detect subtype from strData json, obj["subtype"]
...
void CGovernanceObject::UpdateSentinelVariables()
{
    ...
    // to do - 12.1 - should be set to `10` after governance vote compression is implemented
    ...
    // to do - 12.1 - Temporarily set to 1 for testing - reverted
    //nAbsVoteReq = 1;
