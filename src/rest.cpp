...
extern UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false, bool verbose = false, bool prayers = true);
                       ...
                       bool showTxDetails)
{
    ...
    CBlockIndex* pblockindex = NULL;
    {
        ...
        if (!ReadBlockFromDisk(block, pblockindex, Params().GetConsensus(), "REST_BLOCK"))
            return RESTERR(req, HTTP_NOT_FOUND, hashStr + " not found");
    }
    ...
    case RF_JSON: {
        UniValue objBlock = blockToJSON(block, pblockindex, showTxDetails, false, true);
