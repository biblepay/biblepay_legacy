...
extern UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false, bool verbose = false);
                       ...
                       bool showTxDetails)
{
    ...
    case RF_JSON: {
        UniValue objBlock = blockToJSON(block, pblockindex, showTxDetails, false);
